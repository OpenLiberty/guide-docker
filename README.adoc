...
----
Create the file `start/Dockerfile`.
----
Dockerfile
[source, linenums, role="code_column"]
----
...
----
Replace the `start/src/main/java/io/openliberty/guides/rest/PropertiesResource.java` class.
----
