...
development mode with will be used to build the image and container, otherwise the default Open Liberty image, 
...
----
include::finish/PropertiesResource.java[]
----
...
Any options that you would normally add to the `docker run` command, can be added to this option. Below
...
[source, java, linenums, role="code_column"]
----
include::finish/EndpointIT.java[]
----
