...
pom.xml
[source, xml, indent=0, linenums, role="code_column"]
----
...
Dockerfile
[source, indent=0, linenums, role="code_column"]
----
...
[role="code_command hotspot=31", subs="quotes"]
----
Replace the `src/main/java/io/openliberty/guides/rest/PropertiesResource.java` class and change the `@Path`
annotation to `"properties-new"`.
----

PropertiesResource.java
[source, Java, indent=0, linenums, role="code_column"]
----
include::src/main/java/io/openliberty/guides/rest/PropertiesResource.java[tags=**]
----

 These edits change the endpoint of your application from `/properties` to `/properties-new`.
