...
As mentioned previously, the `devc` goal can be used with or without a Dockerfile. 
...
Additionally, both of these options can be added to the `pom.xml` file under the `<configuration>` 
