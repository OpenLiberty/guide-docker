...
or directories you wish to exlcude one from the build context, you can add them
...
If your container runs without problems, go to the http://localhost:9080/system/properties[http://localhost:9080/system/properties^] URL 
