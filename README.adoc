...
development mode with will use it to build the image, otherwise the default Open Liberty image will be used. The default 
Open Liberty Image can be found here (`openliberty/open-liberty:kernel-java8-openj9-ubi`).
