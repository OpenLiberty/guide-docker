...
Before you begin, you need to have `Docker` installed. For installation instructions, refer to the https://docs.docker.com/get-docker/[^official Docker documentation]. You will build and run the application in Docker containers.
...
command from the command line. If you execute your build from the same directory as your Dockerfile,
