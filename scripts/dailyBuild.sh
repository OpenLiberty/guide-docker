...
sed -i "\#<assemblyArtifact>#,\#</assemblyArtifact>#c<install><runtimeUrl>https://public.dhe.ibm.com/ibmdl/export/pub/software/openliberty/runtime/nightly/'$DATE'/'$DRIVER'</runtimeUrl></install>"
cat pom.xml
